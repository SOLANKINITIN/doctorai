...
router.get('/hospital:id', HospitalController.getHospitalListing);
router.delete('/hospital', HospitalController.deleteHospitalListing);
...
router.get(
  '/updtaeHospital/:hospitalId',
  HospitalController.getHospitalListing
);
